...
def load_page(experiment_df, experiment_db):
    ...
    copy_button.js_on_click(CustomJS(args=dict(source=model_data_source),
    ...
    download_button.js_on_click(CustomJS(args=dict(source=model_data_source, file_name=output_filename),
